  ...
  return `                 <footer class="bg-white mp-fullpage-section-pad mx-auto">
          <div class="mx-auto py-12">
            ...
            >
              ...
              <a
                class="inline-flex items-center gap-2 rounded-full border border-white bg-white px-8 py-3 text-primary hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90 mp-transition-5"
                href="#"
              >
            ...
            >
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-gray-900">Our Stores</p>
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-gray-900">Payment</p>

                <ul class="mt-8 text-sm grid grid-cols-2 gap-2">
                  <li class="h-8">
                    <a
                    ...
                    >
                      <img
                        src="./assets/images/payment/2c46b83d84111ddc32cfd3b5995d9281.png"
                        alt=""
                        class=""
                      />
                    </a>
                  ...
                  <li class="h-8">
                    ...
                    >
                      <img
                        src="./assets/images/payment/38fd98e55806c3b2e4535c4e4a6c4c08.png"
                        alt=""
                        class=""
                      />
                    </a>
                  ...
                  <li class="h-8">
                    ...
                    >
                      <img
                        src="./assets/images/payment/a0a9062ebe19b45c1ae0506f16af5c16.png"
                        alt=""
                        class=""
                      />
                    </a>
                  ...
                  <li class="h-8">
                    <a
                      ...
                      href="#"
                      ><img
                        src="./assets/images/payment/bc2a874caeee705449c164be385b796c.png"
                        alt=""
                        class=""
                    /></a>
                  </li>
                  ...
                  <li class="h-8">
                    ...
                    >
                      <img
                        src="./assets/images/payment/d4bbea4570b93bfd5fc652ca82a262a8.png"
                        alt=""
                      />
                    </a>
                  </li>
            ...
            <div class="mt-16">
              ...
              <div class="mt-16 sm:flex sm:items-center sm:justify-between">
                <div class="flex justify-center text-gray-500 sm:justify-start">
