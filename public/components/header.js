        ...
        >
          <nav class="flex flex-row justify-between items-center">
              ...
              <li class="mp-top-menu-item group">
                ...
                >
                  <div class="py-[20px] text-[13px] w-[400px]">
                    ...
                    <ul
                      class="capitalize font text-gray-500 grid grid-cols-2 my-[20px] px-[40px] gap-x-[80px] gap-y-[20px]"
                    >
                      <li class="">
                        <a href="" class="hover:text-primary mp-transition-3"
                          >beauty</a
                        >
                      </li>
                      <li class="">
            ...
            >
              ...
              <div
                class="text-xl flex flex-row justify-between items-center gap-6"
              >
                <!-- User -->
                <a href="!#"
